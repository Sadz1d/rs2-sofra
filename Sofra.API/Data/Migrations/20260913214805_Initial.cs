        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServingPeriods = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinQuantity = table.Column<decimal>(type: "decimal(10,3)", precision: 10, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MenuItemAId = table.Column<int>(type: "int", nullable: false),
                    MenuItemBId = table.Column<int>(type: "int", nullable: false),
                    PairCount = table.Column<int>(type: "int", nullable: false),
                    ComputedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemPairs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuItemPairs_MenuItems_MenuItemAId",
                        column: x => x.MenuItemAId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MenuItemPairs_MenuItems_MenuItemBId",
                        column: x => x.MenuItemBId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MenuItemId = table.Column<int>(type: "int", nullable: false),
                    OrdersLast30Days = table.Column<int>(type: "int", nullable: false),
                    PopularityScore = table.Column<decimal>(type: "decimal(5,4)", precision: 5, scale: 4, nullable: false),
                    AvgRatingNormalized = table.Column<decimal>(type: "decimal(5,4)", precision: 5, scale: 4, nullable: false),
                    FeatureVectorJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ComputedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuItemStats_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiningTables_AspNetUsers_WaiterId",
                        column: x => x.WaiterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DiningTables_TableTypes_TableTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favorites", x => new { x.UserId, x.MenuItemId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserInteractions_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlternativeAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_AspNetUsers_RepliedById",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_AspNetUsers_WaiterId",
                        column: x => x.WaiterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiningTables_QrCode",
                table: "DiningTables",
                column: "QrCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DiningTables_TableTypeId",
                table: "DiningTables",
                column: "TableTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_DiningTables_WaiterId",
                table: "DiningTables",
                column: "WaiterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemPairs_MenuItemAId_MenuItemBId",
                table: "MenuItemPairs",
                columns: new[] { "MenuItemAId", "MenuItemBId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MenuItemPairs_MenuItemBId",
                table: "MenuItemPairs",
                column: "MenuItemBId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemStats_MenuItemId",
                table: "MenuItemStats",
                column: "MenuItemId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_UserId_ReservationAt",
                table: "Reservations",
                columns: new[] { "UserId", "ReservationAt" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_OrderId_UserId_MenuItemId",
                table: "Reviews",
                columns: new[] { "OrderId", "UserId", "MenuItemId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_WaiterId",
                table: "Reviews",
                column: "WaiterId");

            migrationBuilder.CreateIndex(
                name: "IX_Shifts_EmployeeId_Date_StartTime",
                table: "Shifts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInteractions_MenuItemId",
