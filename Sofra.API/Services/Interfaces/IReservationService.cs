...
public interface IReservationService
{
    ...
    Task<ReservationResponse> GetByIdAsync(int id, int actorUserId, bool isStaff, CancellationToken cancellationToken = default);
    ...
    Task<ReservationResponse> CreateAsync(ReservationRequest request, int actorUserId, CancellationToken cancellationToken = default);
    ...
    Task<ReservationResponse> AssignTableAsync(int id, AssignReservationTableRequest request, CancellationToken cancellationToken = default);
}
